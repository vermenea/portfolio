    ...
    about: {
      ...
      technologies: {
        ...
        frontend: {
          title: 'Front-End',
          description:
            'TypeScript combined with React and Next.js enables creating scalable web applications with modern features and SEO optimization.',
        },
        styling: {
          title: 'Styling & UX',
          description:
            'I care about responsive and aesthetic design, using modern styling tools and prototyping in Figma and Photoshop.',
        },
        tools: {
          title: 'Tools & Backend',
          description:
            'Git facilitates version control, and Node.js enables server creation. I use monitoring and CI/CD tools like Sentry, Postman, and Vercel, along with Firebase services.',
        },
      },
    },
    projects: {
    ...
    about: {
      ...
      technologies: {
        ...
        frontend: {
          title: 'Front-End',
          description:
            'TypeScript w połączeniu z React i Next.js umożliwia tworzenie skalowalnych aplikacji webowych z nowoczesnymi funkcjami i optymalizacją SEO.',
        },
        styling: {
          title: 'Stylowanie i UX',
          description:
            'Dbam o responsywny i estetyczny design, wykorzystując nowoczesne narzędzia stylizacyjne oraz prototypowanie w Figma i Photoshop.',
        },
        tools: {
          title: 'Narzędzia i Backend',
          description:
            'Git ułatwia kontrolę wersji, a Node.js pozwala na tworzenie serwerów. Korzystam z narzędzi monitoringu i CI/CD, takich jak Sentry, Postman i Vercel, oraz z usług Firebase.',
        },
      },
    },
    projects: {
